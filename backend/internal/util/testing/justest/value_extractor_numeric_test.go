...
func TestNumericValueExtractor(t *testing.T) {
	...
	testCases := map[string]testCase{
		...
		"chan int":             {actual: lang.ChanOf(1), expectedOutcome: ExpectSuccess, expected: 1},
		"chan string fails":    {actual: lang.ChanOf("1"), expectedOutcome: ExpectFailure, expectedOutcomePattern: `Unsupported actual value: 1`},
		...
		"pointer int":          {actual: lang.Ptr(1), expectedOutcome: ExpectSuccess, expected: 1},
		"pointer string fails": {actual: lang.Ptr("1"), expectedOutcome: ExpectFailure, expectedOutcomePattern: `Unsupported actual value: 1`},
