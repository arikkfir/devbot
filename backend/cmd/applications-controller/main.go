...
func main() {
	...
	flag.BoolVar(&enableLeaderElection, "leader-elect", false, "Enable leader election, ensuring only one controller is active.")
	opts := zap.Options{
		Development: true,
	}
	...
	if err = (&internal.ApplicationReconciler{
